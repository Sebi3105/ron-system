...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('technician_report', function (Blueprint $table) {
            ...
            // Ensure the foreign keys match the type of the primary keys in the referenced tables (bigInteger for Laravel default)
            $table->unsignedBigInteger('technician_id');
            $table->foreign('technician_id')->references('technician_id')->on('technician')->onDelete('cascade'); // onDelete('cascade') for cascading deletes
