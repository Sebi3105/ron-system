    ...
    <div class="form-container">
        ...
        <form method="post" action="{{ route('customer.store') }}" onsubmit="return confirmAction('Are you sure you want to save this customer?')">
            ...
            <div>
                ...
                <input type="text" name="name" placeholder="Customer Name" required pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed" required />
            </div>
            ...
            <div>
                ...
                <div style="position: relative;">
                    <span 
                        ...
                        position: absolute; 
                        top: 33%; 
                        left: 10px; transform: translateY(-50%); color: black; pointer-events: none; font-size: 15px;">
                        +63
                    </span>
                    <input 
                        type="tel" 
