                    ...
                    <div class="table">
                        <table id="serials">
                            ...
                            <tbody>
                                ...
                                <td class="px-4 py-2 "> {{ $item->service_name }}</td> <!-- Accessing the related inventory's product name -->
                                <td class="px-4 py-2 ">{{ $item->deleted_at }}</td>
                                    <td class="px-4 py-2 flex gap-2">
                                        <!-- Restore Button -->
                                        <form action="{{ route('admin.services.restore', $item->service_id) }}" id="categorydel" method="POST" style="display:inline;">
                                            @csrf
                                            @method('PATCH')
                                        ...
                                        <form action="{{ route('admin.services.forceDelete', $item->service_id) }}" id="categorydel" method="POST"  style="display:inline;">
                                            @csrf
                                            @method('DELETE')
