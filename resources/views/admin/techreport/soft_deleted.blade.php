    ...
    <div class="flex flex-col md:flex-row h-screen">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-2 flex gap-2">
                                        <!-- Restore Button -->
                                        <form action="{{ route('admin.techreport.restore', $item->report_id) }}" id="techdel" method="POST" style="display:inline;">
                                            @csrf
                                            @method('PATCH')
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const createUserForm = document.getElementById('techdel');
