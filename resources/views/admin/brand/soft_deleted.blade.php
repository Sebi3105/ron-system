    ...
    <div class="flex flex-col md:flex-row h-screen">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-2 flex gap-2">
                                        <!-- Restore Button -->
                                        <form action="{{ route('admin.brand.restore', $item->brand_id) }}" id="branddel" method="POST" style="display:inline;">
                                            @csrf
                                            @method('PATCH')
                                        ...
                                        <form action="{{ route('admin.brand.forceDelete', $item->brand_id) }}" id="branddel" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
        ...
        <div id="cancelModal" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 hidden">
            <div class="bg-white max-w-sm w-full rounded-md shadow-lg">
                ...
                <p class="text-gray-700 text-center mb-7">
                ...
                <div class="flex justify-center gap-4">
                    ...
                    <a href="{{ route('admin.brand.soft_deleted') }}" id="confirmCancel" class="px-6 py-3 bg-gradient-to-r from-red-500 to-red-700 text-white rounded-md hover:from-red-600 hover:to-red-800 transition">
                        Confirm
                    </a>
                </div>
            </div>
