                            ...
                            <tbody>
                                ...
                                <tr class="border-b hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-2 flex gap-2">
                                        <!-- Restore Button -->
                                        <form action="{{ route('admin.customer.restore', $item->customer_id) }}" id="categorydel" method="POST" style="display:inline;">
                                            @csrf
                                            @method('PATCH')
                                        ...
                                        <form action="{{ route('admin.customer.forceDelete', $item->customer_id) }}" id="categorydel" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
