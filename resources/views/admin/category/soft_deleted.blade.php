    ...
    <div class="flex flex-col md:flex-row h-screen">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-2 flex gap-2">
                                        <!-- Restore Button -->
                                        <form action="{{ route('admin.category.restore', $item->category_id) }}" id="categorydel" method="POST" style="display:inline;">
                                            @csrf
                                            @method('PATCH')
                                        ...
                                        <form action="{{ route('admin.category.forceDelete', $item->category_id) }}" id="categorydel" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
        ...
        <div id="cancelModal" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 hidden">
            <div class="bg-white max-w-sm w-full rounded-md shadow-lg">
                ...
                <p class="text-gray-700 text-center mb-6">
                    Are you sure you want to delete this permanetly?
                </p>
                <div class="flex justify-center gap-4">
                    <button id="cancelModalClose" class="px-6 py-3 bg-gray-200 text-black rounded-md hover:bg-gray-200 transition">
                        Cancel
                    </button>
                    <a href="{{ route('admin.category.soft_deleted') }}" id="confirmCancel" class="px-6 py-3 bg-gradient-to-r from-red-500 to-red-700 text-white rounded-md hover:from-red-600 hover:to-red-800 transition">
                        Confirm
                    </a>
                </div>
            </div>
