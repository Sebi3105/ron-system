    ...
    <div class="flex flex-col md:flex-row h-screen">
        ...
        <div class="flex-1 md:ml-64 mt-15 bg-gray-100 text-gray-800">
            ...
            <header class="bg-gray-200 py-3 px-3 fixed top-0 md:left-64 right-0 z-20 h-16 flex items-center justify-between text-black shadow-md">
                <h1 class="text-lg font-bold">Create Serial Number for {{ $selectedInventory->product_name }}</h1>
            </header>
            ...
            <div class="form-container mx-auto mt-20 mb-20">
                ...
                <div class="container mx-auto ">
                    ...
                    <small ><i >Note: You can create up to {{ $amount }} serial numbers for this product.</i></small>
                    ...
                    <form id="serialForm" method="post" action="{{ route('inventoryitem.store') }}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <label for="serial_number" class="block text-left text-gray-700 " style="margin-top:1.5rem;">Serial Number</label>
                        ...
                        <div class="form-group mb-4">
                            <!-- Label aligned to the left -->
                            <label for="condition" class="block text-left text-gray-700">Condition</label>
