            ...
            <div class="form-container mx-auto mt-20">
                ...
                <form id="inventoryForm" method="post" action="{{ route('inventoryitem.update', ['inventoryitem' => $inventoryitem->sku_id]) }}">
                    ...
                    <div class="productid_dropdown mb-4">
                        <label class="block text-gray-700 text-left">Category Name</label>
                        <select name="product_id" id="product_id" class="w-full p-2 border border-gray-300 " style="border-radius: 3px;">
                    ...
                    <div class="serial_number mb-4">
                        <label class="block text-gray-700 text-left">Serial Number</label>
                        <input type="text" style="border-radius: 3px;" id="serial_number" name="serial_number" placeholder="Serial Number" value="{{ old('serial_number', $inventoryitem->serial_number) }}" class="w-full p-2 border border-gray-300">
                    </div>

                    <div class="condition mb-4">
                        <label class="block text-gray-700 text-left">Condition</label>

                        <select name="condition" id="condition" class="w-full p-2 border border-gray-300 " style="border-radius: 3px;">
