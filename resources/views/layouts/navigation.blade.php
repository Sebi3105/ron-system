    ...
    <div class="flex flex-col h-full">
        ...
        <div class="flex-1 overflow-y-auto">
            <ul class="space-y-4 flex flex-col">
                ...
                <!-- Notification -->
                <li>
                    <x-nav-link href="{{ url('/notifications') }}" class="text-black w-full px-12 py-2 hover:bg-navy-blue text-center">
                ...
                <!-- Inventory -->
                <li>
                    <x-nav-link href="{{ route('inventory.index') }}" class="text-black w-full px-12 py-2 hover:bg-navy-blue text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
                ...
                <!-- Customer -->
                <li>
                    <x-nav-link href="{{ route('customer.index') }}" class="text-black w-full px-12 py-2 hover:bg-navy-blue text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6">
