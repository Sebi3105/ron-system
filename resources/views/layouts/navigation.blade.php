        ...
        <div class="flex-1 overflow-y-auto">
            <ul class="space-y-4 flex flex-col py-10">
                ...
                <li class="flex items-center space-x-4 px-10 py-1 hover:bg-navy-blue">
                    ...
                    <x-nav-link href="{{ url('/technician') }}" class="text-black w-full">
                        {{ __('Technician') }}
                    </x-nav-link>
                </li>
                <!-- Setting -->
                <li class="flex items-center space-x-4 px-10 py-1 hover: hover:bg-navy-blue">
                ...
                <li class="flex items-center space-x-4 px-10 py-1">
                  ...
                  @csrf
                  <a href="{{ url('/logout') }}" class="text-red-500 text-base" onclick="event.preventDefault(); this.closest('form').submit();">
                  {{ __('Log Out') }}
                  </a>
                </form>
               </li>
