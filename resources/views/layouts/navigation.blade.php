    ...
    <div class="flex flex-col h-full">
        ...
        <div class="flex-1 overflow-y-auto">
            <ul class="space-y-4 flex flex-col">
                <!-- Dashboard -->
                <li>
                    <x-nav-link href="{{ url('/dashboard') }}" class="text-black w-full px-12 py-2 hover:bg-navy-blue text-center">
                ...
                <li>
                    <x-nav-link href="{{ url('/admin/dashboard') }}" class="text-black w-full px-12 py-2 hover:bg-navy-blue text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-2">
                ...
                <!-- Notification -->
                <li>
                    <x-nav-link href="{{ url('/notification') }}" class="text-black w-full px-12 py-2 hover:bg-navy-blue text-center">
                ...
                <x-nav-link 
                    ...
                    class="text-black w-full px-12 py-2 text-center hover:bg-navy-blue {{ request()->routeIs('inventory.index') ? 'bg-navy-blue text-white' : '' }}"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6 mr-2">
                ...
                <!-- Customer -->
                <li>
                    <x-nav-link href="{{ url('/customer') }}" class="text-black w-full px-12 py-2 hover:bg-navy-blue text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6 mr-2">
                ...
                <!-- Sales -->
                <li>
                    <x-nav-link href="{{ url('/sales') }}" class="text-black w-full px-12 py-2 hover:bg-navy-blue text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6 mr-2">
                ...
                <!-- Technician -->
                <li>
                    <x-nav-link href="{{ url('/techreport') }}" class="text-black w-full px-12 py-2 hover:bg-navy-blue text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-6 mr-2">
